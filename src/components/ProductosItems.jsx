    ...
    <div>
      ...
      <div className="space-y-2">
        {productosFiltrados.map(producto => (
          <div
            key={producto.id}
            className="grid grid-cols-[60px_1fr_120px_120px_80px] gap-4 items-center border rounded-lg p-2 shadow-sm hover:shadow transition text-xs"
          >
            {/* Imagen */}
            ...
            <div>
              ...
              <input
                ...
                className="w-full md:w-28 border px-2 py-1 rounded text-right"
              />
            </div>
